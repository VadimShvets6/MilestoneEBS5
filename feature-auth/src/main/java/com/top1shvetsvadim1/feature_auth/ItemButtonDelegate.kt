...
import com.top1shvetsvadim1.feature_auth.databinding.ItemButtonBinding
...
class ItemButtonDelegate : ItemDelegate<ItemButtonUIModel, ItemButtonDelegate.ItemButtonViewHolder>(
    ...
    inner class ItemButtonViewHolder(
        ...
        override fun setOnClickListeners(item: ItemButtonUIModel) {
            binding.itemButton.setOnClickListener {
                pushAction(ActionOnClick.OnItemClicked(item.tag))
            }
